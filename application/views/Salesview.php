            ...
            <div class="container-fluid dashboard-content">
             ...
             <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header p-tb-10 text-center">
                                    <div class="">
                                        <img src="../assets/icon2/skyzen.png" alt="" style="width: 28%;">
                                    </div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header p-tb-10 text-center">
                                    <div class="">
                                        <h3>StarWyn</h3>
<!--                                        <img src="../assets/icon2/skyzen.png" alt="" style="width: 100%;">-->
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="d-inline-block" style="padding-left: 20px;">
