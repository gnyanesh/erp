                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" style="padding: 5px; background-color: #f2f2f2">
                            <div class="">
                                ...
                                <li class="p-tb-10 "><a href="" class="" style="">Dealers</a></li>
                                <li class=" <?=($this->uri->segment(1)==='Sales')?'active':''?> p-tb-10"><a href="<?php echo base_url()?>Sales">Sales</a></li>
                                <li class="p-tb-10 "><a href="" class="" style="">Purchase</a></li>
                                <li class="p-tb-10 "><a href="" class="" style="">ASPs</a></li>
                                <li class="p-tb-10 "><a href="" class="" style="">Employees</a></li>
                                <li class="p-tb-10 "><a href="" class="" style="">Expenses</a></li>
